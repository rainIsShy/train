angular.module('IOne-Production').config(['$routeProvider', function ($routeProvider) {
    $routeProvider.when('/inv/unitConversion', {
        controller: 'UnitConversionController',
        templateUrl: 'app/src/app/inv/unitConversion/unitConversion.html'
    })
}]);

angular.module('IOne-Production').controller('UnitConversionController', function ($scope, UnitConversionService, Constant) {
