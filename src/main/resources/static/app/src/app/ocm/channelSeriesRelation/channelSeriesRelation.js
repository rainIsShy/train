angular.module('IOne-Production').config(['$routeProvider', function ($routeProvider){
    $routeProvider.when('/channelSeriesRelation',{
        controller: 'ChannelSeriesRelationController',
        templateUrl: 'app/src/app/ocm/channelSeriesRelation/channelSeriesRelation.html'
    })
}]);
